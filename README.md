...
### Installation
  ...
  If the atc profile is not available, the application will try to load the default profile. If that is unsuccessful, it will attempt to load the profile from the Instance Profile service on an EC2 instance
